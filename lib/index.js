...
var _ExternalsPlugin = require('webpack/lib/ExternalsPlugin');

var _ExternalsPlugin2 = _interopRequireDefault(_ExternalsPlugin);
...
var ServiceWorkerPlugin = function () {
  ...
  _createClass(ServiceWorkerPlugin, [{
    ...
    value: function handleMake(compilation, compiler) {
      ...
      new _ExternalsPlugin2.default('var', compiler.options.externals).apply(childCompiler);
    ...
    value: function handleEmit(compilation, compiler, callback) {
      ...
      templatePromise.then(function (template) {
        ...
        var importSource = _this2.compiledChunkFilenames.map(function (filename) {
